...
# Script purpose: Wrangling the parameters file created by hDDMrl.
# @author: Corrado Caudek <corrado.caudek@unifi.it>
# Date Created: Mon Nov  1 06:53:31 2021
# Last Modified Date: Mon Nov  1 06:53:31 2021
# 
# Notes: 
...
#' @save
#' RDS file.
add_subj_code_to_hddm_params_and_save <- function() {
  ...
  # params_prl_ddm <- rio::import( ## OLD DATA
  #   here::here("data", "processed", "prl", "output_hddm", "params_hddm.txt")
  # )
  params_prl_ddm <- rio::import(
    here::here("data", "processed", "prl", "output_hddm", "params_hddm_2022_03_03.txt")
  )
